...
public class MeasurementsController {
    ...
    @GetMapping(value = "/secure/timeseries/downloadTimeseries")
    public String elasticsearchDownload(Model model, HttpSession session, HttpServletRequest request) {
        ...
        model.addAttribute(ELASTICSEARCH_CLASS_SETTINGS, CLASS_SETTINGS_STATE);
        model.addAttribute(ELASTICSEARCH_URL, elasticsearchURL);
        return "secure/elasticsearchDownloadTimeseries";
    }


    @GetMapping(value = "/secure/timeseries/uploadTimeseries")
    ...
    @GetMapping(value = "/secure/timeseries/pingTimeseries")
    ...
    @GetMapping(value = "/secure/Subnets/147_102_13_0_24")
    public String elasticsearchSubnets147n102n13n0m24(Model model, HttpSession session, HttpServletRequest request) {
        String elasticsearchURL;
        elasticsearchURL = environment.getProperty(KIBANA_PROTOCOL) + "://" + environment.getProperty(SERVER_HOST_NAME) + ":" + environment.getProperty(KIBANA_PORT) +
    ...
    @GetMapping(value = "/secure/HWProbes/HWProbe1")
    public String elasticsearchHWProbe1(Model model, HttpSession session, HttpServletRequest request) {
        ...
        model.addAttribute(HWPROBES_CLASS_SETTINGS, CLASS_SETTINGS_STATE);
        model.addAttribute(ELASTICSEARCH_URL, elasticsearchURL);
        return "secure/elasticsearchHWProbes1";
    }

    @GetMapping(value = "/secure/HWProbes/HWProbe2")
    ...
    @GetMapping(value = "/secure/HWProbes/HWProbe3")
    ...
    @GetMapping(value = "/secure/HWProbes/HWProbe4")
    ...
    @GetMapping(value = "/secure/HWProbes/HWProbe5")
    ...
    @GetMapping(value = "/secure/HWProbes/HWProbe6")
    ...
    @GetMapping(value = "/secure/HWProbes/HWProbe7")
    ...
    @GetMapping(value = "/secure/HWProbes/HWProbe8")
    ...
    @GetMapping(value = "/secure/HWProbes/HWProbe9")
    ...
    @GetMapping(value = "/secure/HWProbes/HWProbe10")
