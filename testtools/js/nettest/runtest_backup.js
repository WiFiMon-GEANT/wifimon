...
NetTest.testDownload = function(imagePath, imageSize) {
 ...
 var handler = function(resultObj) {
  ...
  //NetTest.testUpload(images_location + "medium.jpg", 1320354); //mine
  NetTest.testUpload(images_location + "tiny.gif", 670);
 }
...
NetTest.testGeneral = function() {
 ...
 //NetTest.testDownload(images_location + "large.jpg", 4995543); //mine
 NetTest.testDownload(images_location + "tiny.gif", 670);
}
