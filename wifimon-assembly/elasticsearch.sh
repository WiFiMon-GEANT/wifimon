...
curl -XPUT 'http://WAS_FQDN:9200/wifimon?pretty' -H 'Content-Type: application/json' -d'
{
	"mappings" : {
		"properties" : {
			"timestamp" : { "type" : "date" },
...
# Create probes index
curl -XPUT 'http://WAS_FQDN:9200/probes?pretty' -H 'Content-Type: application/json' -d'
{ 
	"mappings" : {
		"properties" : {
			"timestamp" : { "type" : "date" },
...
curl -XPUT 'http://WAS_FQDN:9200/radiuslogs?pretty' -H 'Content-Type: application/json' -d' 
{
	"mappings" : {
		"properties" :  {
		      "Timestamp" : { "type" : "date" },
...
curl -XPOST 'http://WAS_FQDN:9200/wifimon/_doc/?pretty' -H 'Content-Type: application/json' -d' { "test" : "test" }'

curl -XPOST 'http://WAS_FQDN:9200/radiuslogs/_doc/?pretty' -H 'Content-Type: application/json' -d' { "test" : "test" }'

curl -XPOST 'http://WAS_FQDN:9200/probes/_doc/?pretty' -H 'Content-Type: application/json' -d' { "test" : "test" }'
